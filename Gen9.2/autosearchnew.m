function [pathofDTA,DTAnum,foldernum]=autosearchnew(genfilepath,cengshu,pathofDTA,DTAnum,foldernum)
...
if(cengshu<4)
    ...
    if(Allpathlength>2)
        ...
        for i=3:Allpathlength
            if(Allpath(i).isdir)
                [pathofDTA,DTAnum,foldernum]=autosearchnew([Allpath(i).folder,'\',Allpath(i).name,'\'],cengshu,pathofDTA,DTAnum,foldernum);
            else
                continue
            end
        end
